...
- Name: 03-buttons.spec.ts >> Button Elements >> TC-012: Button hover state is accessible
- Location: tests\03-buttons.spec.ts:31:7
...
```
Error: page.goto: net::ERR_CONNECTION_RESET at https://www.qa-practice.com/elements/button/simple
Call log:
